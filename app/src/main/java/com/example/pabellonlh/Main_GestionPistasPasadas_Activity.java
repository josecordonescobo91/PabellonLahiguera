...
public class Main_GestionPistasPasadas_Activity extends AppCompatActivity implements View.OnClickListener {
    String usuario;
    TextView tvNombre;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main__gestion_pistas_pasadas_);

        Intent intent = getIntent();
        usuario = intent.getStringExtra("usuario");
        intent.putExtra("usuario", usuario);

       // Toast.makeText(Main_GestionPistasPasadas_Activity.this, usuario, Toast.LENGTH_SHORT).show();
        ...
        PistasOcupadasF7("http://jose-cordones.es/app/consultas/obtenerPistasPasadas.php?pista="+Futbol7);
        PistasOcupadasF7P2("http://jose-cordones.es/app/consultas/obtenerPistasPasadas.php?pista="+Futbol7P2);
        PistasOcupadasFS("http://jose-cordones.es/app/consultas/obtenerPistasPasadas.php?pista="+FutbolSala);
        PistasOcupadasP("http://jose-cordones.es/app/consultas/obtenerPistasPasadas.php?pista="+Padel);
        PistasOcupadasC("http://jose-cordones.es/app/consultas/obtenerPistasPasadas.php?pista="+PadelCubierto);
        PistasOcupadasT("http://jose-cordones.es/app/consultas/obtenerPistasPasadas.php?pista="+Tennis);
        ejecutarTarea();
        ...
        btnBuscarT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner3.equals("")){
                    Toast.makeText(Main_GestionPistasPasadas_Activity.this, "DEBE SELECCIONAR UNA FECHA", Toast.LENGTH_SHORT).show();
                }else {
                    BusquedaFechaT("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasPasadas.php?pista=" + Tennis + "&fecha=" + valorSpiner3);
        ...
        btnBuscarP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner2.equals("")){
                    ...
                    BusquedaFechaP("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasPasadas.php?pista=" + Padel + "&fecha=" + valorSpiner2);
        ...
        //botones padel CUBIERTO----------------------------------------------------------------------------------------------------------------------------------------
        btnBuscarC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String valorSpiner11 = edFechaC.getText().toString();
                if(valorSpiner11.equals("")){
                    Toast.makeText(Main_GestionPistasPasadas_Activity.this, "DEBE SELECCIONAR UNA FECHA", Toast.LENGTH_SHORT).show();
                }else {
                    BusquedaFechaC("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasPasadas.php?pista=" + PadelCubierto + "&fecha=" + valorSpiner11);
        ...
        btnBuscarF7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner.equals("")){
                    ...
                    BusquedaFechaF7("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasPasadas.php?pista="+Futbol7+"&fecha="+ valorSpiner);
                    edFechaF7.setText("");
        ...
        btnBuscarP2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String valorSpiner10 = edFechaP2.getText().toString();
                if(valorSpiner10.equals("")){
                    Toast.makeText(Main_GestionPistasPasadas_Activity.this, "DEBE SELECCIONAR UNA FECHA", Toast.LENGTH_SHORT).show();
                }else{
                    BusquedaFechaF7P2("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasPasadas.php?pista="+Futbol7P2+"&fecha="+ valorSpiner10);
                    edFechaP2.setText("");
        ...
        btnBuscarFS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner1.equals("")){
                    ...
                    BusquedaFechaFS("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasPasadas.php?pista=" + FutbolSala + "&fecha=" + valorSpiner1);
    ...
    public void BusquedaFechaT(String URL){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response2.equals("")){
                    Toast.makeText(Main_GestionPistasPasadas_Activity.this, "EL DIA SELECCIONADO NO SE ALQUILARON PISTAS DE PADEL", Toast.LENGTH_SHORT).show();
                    lvPistasLibresT.setVisibility(View.VISIBLE);
                    lvBusquedaT.setVisibility(View.INVISIBLE);
    ...
    public void CargarListViewBusquedaT(JSONArray ja, final String usuario, final String dia) {
        ...
        lvBusquedaT.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Main_GestionPistasPasadas_Activity.this, Main_EditarEliminarPistasPasadas_Activity.class);
    ...
    public void BusquedaFechaFS(String URL){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response2.equals("")){
                    Toast.makeText(Main_GestionPistasPasadas_Activity.this, "EL DIA SELECCIONADO NO SE ALQUILARON PISTAS DE FUTBOL SALA", Toast.LENGTH_SHORT).show();
                    lvPistasLibresFS.setVisibility(View.VISIBLE);
                    lvBusquedaFS.setVisibility(View.INVISIBLE);
    ...
    public void BusquedaFechaF7(String URL){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response2.equals("")){
                    Toast.makeText(Main_GestionPistasPasadas_Activity.this, "EL DIA SELECCIONADO NO SE ALQUILARON PISTAS DE FUTBOL 7", Toast.LENGTH_SHORT).show();
                    lvPistasLibresF7.setVisibility(View.VISIBLE);
                    lvBusquedaF7.setVisibility(View.INVISIBLE);
