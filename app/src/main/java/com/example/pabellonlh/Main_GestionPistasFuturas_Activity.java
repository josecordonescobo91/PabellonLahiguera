...
public class Main_GestionPistasFuturas_Activity extends AppCompatActivity implements View.OnClickListener {
    String usuario;
    TextView tvNombre;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main__gestion_pistas_futuras_);
       ...
       // Toast.makeText(Main_GestionPistasFuturas_Activity.this, usuario, Toast.LENGTH_SHORT).show();
        ...
        PistasOcupadasF7("http://jose-cordones.es/app/consultas/obtenerPistasFuturas.php?pista="+Futbol7);
        PistasOcupadasF7P2("http://jose-cordones.es/app/consultas/obtenerPistasFuturas.php?pista="+Futbol7P2);
        PistasOcupadasFS("http://jose-cordones.es/app/consultas/obtenerPistasFuturas.php?pista="+FutbolSala);
        PistasOcupadasP("http://jose-cordones.es/app/consultas/obtenerPistasFuturas.php?pista="+Padel);
        PistasOcupadasC("http://jose-cordones.es/app/consultas/obtenerPistasFuturas.php?pista="+PadelCubierto);
        PistasOcupadasT("http://jose-cordones.es/app/consultas/obtenerPistasFuturas.php?pista="+Tennis);
        ejecutarTarea();
        ...
        btnBuscarT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner3.equals("")){
                    Toast.makeText(Main_GestionPistasFuturas_Activity.this, "DEBE SELECCIONAR UNA FECHA", Toast.LENGTH_SHORT).show();
                }else {
                    BusquedaFechaT("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasFuturas.php?pista=" + Tennis + "&fecha=" + valorSpiner3);
        ...
        btnBuscarC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String valorSpinerPC = edFechaC.getText().toString();
                if(valorSpinerPC.equals("")){
                    Toast.makeText(Main_GestionPistasFuturas_Activity.this, "DEBE SELECCIONAR UNA FECHA", Toast.LENGTH_SHORT).show();
                }else {
                    BusquedaFechaC("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasFuturas.php?pista=" + PadelCubierto + "&fecha=" + valorSpinerPC);
        ...
        btnBuscarP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner2.equals("")){
                    ...
                    BusquedaFechaP("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasFuturas.php?pista=" + Padel + "&fecha=" + valorSpiner2);
        ...
        btnBuscarF7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner.equals("")){
                    ...
                    BusquedaFechaF7("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasFuturas.php?pista="+Futbol7+"&fecha="+ valorSpiner);
                    edFechaF7.setText("");
        ...
        btnBuscarP2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String valorSpinerF2 = edFechaP2.getText().toString();
                if(valorSpinerF2.equals("")){
                    Toast.makeText(Main_GestionPistasFuturas_Activity.this, "DEBE SELECCIONAR UNA FECHA", Toast.LENGTH_SHORT).show();
                }else{
                    BusquedaFechaF7F2("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasFuturas.php?pista="+Futbol7P2+"&fecha="+ valorSpinerF2);
                    edFechaP2.setText("");
        ...
        btnBuscarFS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valorSpiner1.equals("")){
                    ...
                    BusquedaFechaFS("http://jose-cordones.es/app/consultas/obtenerBusquedaPistasFuturas.php?pista=" + FutbolSala + "&fecha=" + valorSpiner1);
    ...
    public void BusquedaFechaT(String URL){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response2.equals("")){
                    Toast.makeText(Main_GestionPistasFuturas_Activity.this, "EL DIA SELECCIONADO NO SE HA ALQUILADO PISTAS DE PADEL TODAVIA", Toast.LENGTH_SHORT).show();
                    lvPistasLibresT.setVisibility(View.VISIBLE);
                    lvBusquedaT.setVisibility(View.INVISIBLE);
    ...
    public void CargarListViewBusquedaT(JSONArray ja, final String usuario, final String dia) {
        ...
        lvBusquedaT.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Main_GestionPistasFuturas_Activity.this, Main_EditarEliminarPistasFuturas_Activity.class);
            ...
            public void onResponse(String response) {
                ...
                if(response2.equals("")){
                    ...
                    try {
                        ...
                        String usuario = intent.getStringExtra("usuario");
                        String pista = intent.getStringExtra("pista");
                        CargarListViewBusquedaPC(ja, usuario, pista);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
    ...
    public void CargarListViewBusquedaPC(JSONArray ja, final String usuario, final String dia) {
    ...
    //pistas futbol 7-------------------------------------------------------------------------------------------------------------------------
    public void BusquedaFechaF7F2(String URL){
